...
class Sorted_List:
    ...
    def insert(self, value):
        ...
        if previous is None:
            ...
            previous._next = new_node  # type: ignore
    ...
    def _linear_search(self, key):
        ...
        while current is not None and key > current._value:
            ...
            current = current._next
            index += 1
        if current is None or key < current._value:
            index = -1
    ...
    def clean(self):
        ...
        while current is not None and current._next is not None:
            if current._value == current._next._value:
                self._delete_node(current, current._next)
            else:
                current = current._next
        return
    ...
    def pop(self, *args):
        ...
        if previous is None:
            # Update the front
            self._front = current._next  # type: ignore
        else:
    ...
    def intersection(self, source1, source2):
        ...
        (iterative algorithm)
        Use: target.intersecti on(source1, source2)
        -------------------------------------------------------
        Parameters:
            ...
            if current1._value < current2._value:
                ...
                if self._rear is None or self._rear._value != current1._value:
                    ...
                    if self._rear is None:
                        ...
                        self._rear._next = new_node  # type: ignore
                    self._rear = new_node
                    self._count += 1
                current1 = current1._next
                current2 = current2._next
    ...
    def union(self, source1, source2):
        ...
        for source in source_list:
            ...
            while node is not None:
                if node._value not in values:
                    self.insert(node._value)
                    values.insert(node._value)
                node = node._next
    ...
    def __eq__(self, target):
        ...
        if self._count != target._count:
            ...
            while source_node is not None and target_node is not None:
