...
class Queue:
    ...
    def __eq__(self, target):
        ...
        self_values = sorted([x for x in self if x is not None])
        target_values = sorted([x for x in target if x is not None])

        equals = self_values == target_values
        return equals
